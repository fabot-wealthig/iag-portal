...
export default function CoiOverviewPanel() {
  return (
    <div>
      ...
      <div style={sectionStyle}>
        ...
        <p style={emptyBodyStyle}>
          This is where every COI will be listed side by side with their mothership, level, client count and revenue share to date.
        </p>
      </div>
    </div>
  )
